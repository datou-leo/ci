/* This file is created by mysqliReback 2018-05-25 13:36:37 */
 /* 创建表结构`ci_admin_act`*/
 ...
 /* 插入数据`ci_admin_user`*/
 INSERT INTO`ci_admin_user`VALUES('administrator','e10adc3949ba59abbe56e057f20f883e','admin','','','','','','','','0','127.0.0.1','127.0.0.1','22','1527209936');/* mysqliReback Separation */
 /* 创建表结构`ci_article`*/
 ...
 /* 插入数据`ci_config`*/
 INSERT INTO`ci_config`VALUES('1','admin','backup','1527073822'),('2','site','title','大头'),('3','site','keywords','大头'),('4','site','description','大头');/* mysqliReback Separation */
 /* 创建表结构`ci_single`*/
 ...
 CREATE TABLE `ci_single` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;/* mysqliReback Separation */
 /* 插入数据`ci_single`*/
 ...
 /* 创建表结构`ci_users`*/
 DROP TABLE IF EXISTS`ci_users`;/* mysqliReback Separation */ 
 CREATE TABLE `ci_users` (
  ...
  `title` varchar(100) DEFAULT '' COMMENT '昵称',
  ...
  `show` tinyint(4) DEFAULT '0' COMMENT '显隐',
  `timeline` int(11) DEFAULT '0' COMMENT '创建时间',
  `last_login` int(11) DEFAULT '0' COMMENT '上次登陆时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;/* mysqliReback Separation */
 /* 插入数据`ci_users`*/
 INSERT INTO`ci_users`VALUES('1','1','0','admin','7fef6171469e80d32c0559f88b377245','','','','','','','0','0','1527063522','1527222986');/* mysqliReback Separation */
 /* 创建表结构`ci_users_auth`*/
 DROP TABLE IF EXISTS`ci_users_auth`;/* mysqliReback Separation */ 
 CREATE TABLE `ci_users_auth` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sort_id` int(11) DEFAULT '1' COMMENT '排序编号',
  `type_id` int(11) DEFAULT '0' COMMENT '用户id',
  `token` varchar(255) DEFAULT '' COMMENT 'token',
  `audit` tinyint(4) DEFAULT '0' COMMENT '审核',
  `show` tinyint(4) DEFAULT '0' COMMENT '显隐',
  `expired_at` int(11) DEFAULT '0' COMMENT '过期时间',
  `timeline` int(11) DEFAULT '0' COMMENT '创建时间',
  `updated_at` int(11) DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;/* mysqliReback Separation */
 /* 插入数据`ci_users_auth`*/
 INSERT INTO`ci_users_auth`VALUES('1','1','1','05d6a571b0e03c1bc8a46d1d5afd00cd','0','0','1527269121','1527222986','1527225921');/* mysqliReback Separation */